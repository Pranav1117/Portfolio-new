...
<span className={`ti ${isIntersecting ? 's' : ''}`}>r </span>
    ...
    <div className={`about-content ${isIntersecting ?'s':''}`}>
        <p className={`info ${isIntersecting ?'s':''}`}>
          After my graduation (BSc aviation) I enrolled in full stack development course. During that course I learn about React, Javascript, Node, ExpressJs, HTML, CSS, Mongoose, MongoDB. During the course I completed couple of projects you can check that out in project's section. 
          I can create visually apealing, responsive, user-friendly websites. when I'm not coding I play games, I try to learn new tricks in web development.    
        </p>
      </div>
    </div>
