  ...
  return (
    <div className="Handson">
      <header>
        <h2>Handson's</h2>
        <p>
          Okay so as I was learning Web Development for the first time, so to
          know how things work, to make strong foundation in MERN I completed on
          several handson for each stack
        </p>
      </header>
